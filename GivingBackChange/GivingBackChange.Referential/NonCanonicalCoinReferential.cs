...
namespace GivingBackChange.Referential
{
    public static class NonCanonicalCoinReferential
    {
        ...
        public static readonly Coin One = new Coin((int)NonCanonicalCoin.One, "1 fm", 1m, 10);
        public static readonly Coin Three = new Coin((int)NonCanonicalCoin.Three, "3 fm", 3m, 10);
        public static readonly Coin Four = new Coin((int)NonCanonicalCoin.Four, "4 fm", 4m, 10);
    }
}
